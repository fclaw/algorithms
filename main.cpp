...
#include "algorithms/onlinejudge/advanced_topics/TradeOnVerweggistan.cpp"
#include <chrono>
#include <iomanip>
#include <bits/stdc++.h>
...
int main(int argc, char* argv[])
{
    ...
    // algorithm starts
    algorithms::onlinejudge::advanced_topics::trade_on_Verweggistan::submit(file, debug_mode);
