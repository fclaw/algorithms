...
namespace algorithms::graph::leetcode::ant
{
    /** 
     ...
     * You can only build one room at a time, and you can travel 
     * freely between rooms you have already built only if they are connected. 
    ...
    */
    int waysToBuildRooms(const std::vector<int>& prevRoom) 
    {
        return 1;    
    }
}