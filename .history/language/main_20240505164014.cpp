...
struct ListNode 
{
  ...
  public:
    void print()
    {
        ...
        do
        {
            std::cout << ptr->val << ptr->next == null " -> ";
            ptr = ptr->next;
...
int main()
{
    ...
    ListNode* list2 = new ListNode(1, new ListNode(3, new ListNode(3)));

    list1->print();

    // auto list = mergeTwoLists(new ListNode(1, new ListNode(2, new ListNode(3))), new ListNode(1, new ListNode(3, new ListNode(3))));
    // list->print();
