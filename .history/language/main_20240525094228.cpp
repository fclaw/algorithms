...
3 Two-pointer technique: For the remaining elements after the fixed element, use two pointers to find pairs that sum up to the required value. Adjust the pointers based on whether the current sum is less than or greater than the required sum.
