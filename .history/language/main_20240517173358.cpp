...
std::vector<std::vector<int>> permuteHelper(std::vector<int> xs, std::vector<int>& curr, std::vector<std::vector<int>>& xxs)
{
    if(xs.size() == 1)
      curr.push_back(xs[0]);
...
int main()
{
    ...
    permuteHelper(permutationXs, allPermutations);
