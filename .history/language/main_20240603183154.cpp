...
ListNode* addTwoNumbersHelper(ListNode* first, ListNode* second, std::optional<int>& carryOverOne)
{
     ...
     return addTwoNumbersHelper(first->next, second->next, make_optional(12))->next = node;
}

ListNode* addTwoNumbers(ListNode* xs, ListNode* ys) { return addTwoNumbersHelper(xs, ys, std::nullopt); }
