...
ListNode addTwoNumbersHelper(ListNode* first, ListNode* second, std::optional<int>& carryOverOne, ListNode* curr)
{   
     ...
     addTwoNumbersHelper(first->next, second->next, carryOverOne)->next = node;
}
