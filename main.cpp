...
#include "algorithms/onlinejudge/advanced_topics/AdventureOfSuperMario.cpp"
#include <chrono>
#include <iomanip>
#include <bits/stdc++.h>
...
int main(int argc, char* argv[])
{
    ...
    // algorithm starts
    algorithms::onlinejudge::advanced_topics::adventure_of_super_Mario::submit(file, debug_mode);
