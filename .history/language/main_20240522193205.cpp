...
vector<vector<int>>& combinationSum(vector<int>& candidates, int target, vector<vector<int>>& res)
{
    ...
    for (size_t i = 0; i < candidates.size(); i++)
    {
      ...
      combinationSumHelper(i, candidates.size(), xs, candidates[i], ys, target, combinationXs);
    }
