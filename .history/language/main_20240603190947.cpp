...
void addTwoNumbersHelper(ListNode* first, ListNode* second, ListNode* curr, std::optional<int>& carryOverOne)
{   
...
{ 
  ...
  ListNode* tail 
  return addTwoNumbersHelper(xs, ys, carryOverOne, nullptr); 
}
