...
#include "algorithms/onlinejudge/advanced_topics/Gentlemen'sAgreement.cpp"
#include <chrono>
#include <iomanip>
#include <bits/stdc++.h>
...
int main(int argc, char* argv[])
{
    ...
    // algorithm starts
    algorithms::onlinejudge::advanced_topics::gentlemen_s_agreement::submit(file, debug_mode);
    // algorithm ends
