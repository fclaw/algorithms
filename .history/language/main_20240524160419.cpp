...
where the innermost loop is optimized using two pointers to avoid unnecessary comparisons. This approach ensures that we can find the solution in 𝑂(𝑛2) time complexity.
*/
