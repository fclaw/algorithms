...
int main(int argc, char* argv[])
{
    ...
    // {3,9,2,3,7,8,3,3}
    // boxes::vi xs =
    // {37,33,52,37,79,59,53,77,39,66,1,56,1,83,51,65,67,47,21,
    //  9,48,55,19,62,37,58,85,36,33,39,19,55,61,99,41,84,76,85,
    //  65,78,69,49,46,73,47,80,14,55,43,87,88,51,81,65,86,45,100,
    //  31,100,5,7,16,59,37}; // 86

    boxes::vi xs = {1,2,2,1,1,1,2,1,1,2,1,2,1,1,2,2,1,1,2,2,1,1,1,2,2,2,2,1,2,1,1,2,2,1,2,1,2,2,2,2,2,1,2,1,2,2,1,1,1,2,2,1,2,1,2,2,1,2,1,1,1,2}; // 29
    cout << boxes::removeBoxes(xs);
    // cout << "cnt: " << b.count << "\n"; 

    // boxes::BOX_SIZE =  xs.size();
    // boxes::vbox boxes = boxes::getBoxes(xs, 0, xs.size()); 
    // for(auto bx : boxes)
