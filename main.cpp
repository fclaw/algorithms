...
#include "algorithms/onlinejudge/advanced_topics/SchedulingLectures.cpp"
#include <chrono>
#include <iomanip>
#include <bits/stdc++.h>
...
int main(int argc, char* argv[])
{
    ...
    // algorithm starts
    algorithms::onlinejudge::advanced_topics::scheduling_lectures::submit(file, debug_mode);
