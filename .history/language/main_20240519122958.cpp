...
{
    size_t ptr_to_zero = 0;
    while(nums[ptr_to_zero] != 0 && ptr_to_zero < nums.size()) 
      ptr_to_zero++;

    size_t ptr_to_non_zero = 0;
    while(nums[ptr_to_non_zero] == 0 && ptr_to_non_zero < nums.size()) 
      ptr_to_non_zero++;
