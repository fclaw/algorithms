...
// max profit if buy on the first day and sell on 
// straightforward solution: pick up an element from an outer loop, traverse from the next element to the left and collect max
